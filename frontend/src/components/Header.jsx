...
//   - Añade enlace "Comparar" con badge que muestra cuántas motos
//     están en la lista de comparación (lee localStorage 'compare_ids').
//   - Se actualiza en tiempo real cuando MotoCard modifica la lista.
  ...
  return (
    <header className="site-header">
      <div className="header-inner">
        {/* Logo */}
        <Link to="/main" className="header-logo" aria-label="MotorMatch - Página principal">
            ...
            {menuAbierto && (
              <ul className="user-dropdown" role="menu">
                ...
                <li role="none">
                  ...
                  >
                    <span className="material-symbols-outlined tune-icon">logout</span>
                    Cerrar sesión
                  </button>
                </li>
              </ul>
